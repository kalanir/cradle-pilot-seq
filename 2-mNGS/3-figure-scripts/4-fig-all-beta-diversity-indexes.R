...
## genus
# Read in processed data
genus_percent = readRDS(paste0(data_dir, "Bracken_processed_data/all/genus_percentages.RDS"))
...
combined_species
ggsave(combined_species, filename = paste0(figure_path, "fig-all-beta-species-bracken",".png"), height = 4.5, width = 10)
...
ggsave(combined_genus, filename = paste0(figure_path, "fig-all-beta-genus-bracken",".png"), height = 4.5, width = 10)
